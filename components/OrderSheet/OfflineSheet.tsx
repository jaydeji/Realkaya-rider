      ...
      <View className="p-5">
        <TouchableOpacity>
          <View className="flex-row items-center justify-between py-4 pl-[10px] pr-[22px] shadow-1 bg-white">
            <BatteryIcon />
            <View>
              <Text className="text-sm font-Mulish-SemiBold text-primary">
        ...
        <View className="mt-5 flex-row justify-between items-center pr-[22px]">
          <View>
            ...
            <View className="flex-row items-center justify-between pb-[14px] border-b border-b-alt-3 mt-3">
              <Text className="text-primary font-Mulish-SemiBold text-xl">
                ₦0.00
              </Text>
            </View>
          </View>
        ...
        <View className="mt-5 flex-row justify-between items-center pr-[22px]">
          <View>
            ...
            <View className="flex-row items-center justify-between pb-[14px] border-b border-b-alt-3 mt-3">
              <Stars value={4} />
              <Text className="text-primary font-Mulish-SemiBold text-xl ml-2">
                5.0
              </Text>
            </View>
          </View>
